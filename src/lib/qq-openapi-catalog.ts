export const QQ_OPENAPI_ENDPOINTS = {
  ...
  getGlobalMenu: { method: "GET", path: "/v2/menu", title: "查询全局自定义菜单" },
  updateGlobalMenu: { method: "PUT", path: "/v2/menu", title: "修改全局自定义菜单" },
  createCommandPanel: { method: "POST", path: "/v2/panels", title: "创建指令面板" },
  listCommandPanels: { method: "GET", path: "/v2/panels", title: "查询指令面板列表" },
  deleteCommandPanel: { method: "DELETE", path: "/v2/panels/{panel_id}", title: "删除指令面板" },
  getCommandPanel: { method: "GET", path: "/v2/panels/{panel_id}", title: "查询指令面板详情" },
  updateCommandPanelTarget: { method: "PUT", path: "/v2/panels/{panel_id}/target", title: "修改指令面板关联对象" },
  updateCommandPanel: { method: "PUT", path: "/v2/panels/{panel_id}", title: "修改指令面板" },
